...
Lab query-state membrane, stage a typed secure ping, check the install floor,
run an issue resolver receipt, write the domain register, write the core target
...
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command lab-query-state -RoamingHttp $true -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command typed-secure-ping -RegisteredEmail "operator@example.invalid" -SecurePingNonce "external-nonce" -RegisteredAccountConfirmed $true -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command sli-register -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command engram-passage -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command gel-closure -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command witness-learning -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command service-heartbeat -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command bounded-refinement-ticket -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command job-slice-guard -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command lease-check -LeaseMinutes 10 -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command receipt-export -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command security-hardening -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command install-floor-check -InstallFailureMode operator-instruction-engagement-unresolved -IssueId floor-001 -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command issue-resolver -InstallFailureMode operator-instruction-engagement-unresolved -IssueId floor-001 -IssueResolverApproved $true -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command domain-register -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command core-targets -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command swarm-refinement -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command lisp-control-matrix-register -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command lisp-matrix-control-seat -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command standing-wave-form -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command resonance-chamber-probe -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command universal-form-register -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command domain-morphism-register -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command capability-composition-probe -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command career-spline-probe -Json
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command selfgel-fibre-register -Json
...
.\plugins\sanctuary-cme\scripts\Invoke-SanctuaryCme.ps1 -Command typed-admission-decant -Json
